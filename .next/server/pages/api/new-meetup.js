...
const handler = async (req, res) => {
  if (req.method === "POST") {
    ...
    const client = await mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"].connect("mongodb+srv://admin:admin@cluster0.tcybw5n.mongodb.net/meetupsDB");
    const db = client.db(); // console.log("client ===> ", client);
    // console.log("db ===> ", db);
